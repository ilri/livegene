 ...
 */
final class Version20190329161508 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        , facebook_data CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --\' COLLATE BINARY --\' COLLATE BINARY --(DC2Type:json)
        , twitter_uid CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , twitter_name CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , twitter_data CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --\' COLLATE BINARY --\' COLLATE BINARY --(DC2Type:json)
        , gplus_uid CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , gplus_name CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:json)
        , gplus_data CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --\' COLLATE BINARY --\' COLLATE BINARY --(DC2Type:json)
        ...
        , provider_metadata CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --\' COLLATE BINARY --\' COLLATE BINARY --(DC2Type:json)
        , length CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --(DC2Type:json)
