 ...
 */
final class Version20190408211143 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_sampling_activity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, description VARCHAR(100) NOT NULL COLLATE BINARY, CONSTRAINT FK_E8649EF6166D1F9C FOREIGN KEY (project_id) REFERENCES app_project (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__media__media_audit AS SELECT id, rev, description, enabled, provider_status, width, height, content_size, cdn_is_flushable, cdn_flush_at, cdn_status, updated_at, created_at, name, provider_name, provider_reference, length, content_type, copyright, author_name, context, cdn_flush_identifier, revtype, provider_metadata FROM media__media_audit');
        $this->addSql('DROP TABLE media__media_audit');
        $this->addSql('CREATE TABLE media__media_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY, enabled BOOLEAN DEFAULT NULL, provider_status INTEGER DEFAULT NULL, width INTEGER DEFAULT NULL, height INTEGER DEFAULT NULL, content_size INTEGER DEFAULT NULL, cdn_is_flushable BOOLEAN DEFAULT NULL, cdn_flush_at DATETIME DEFAULT NULL, cdn_status INTEGER DEFAULT NULL, updated_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, provider_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, provider_reference VARCHAR(255) DEFAULT NULL COLLATE BINARY, length NUMERIC(10, 0) DEFAULT NULL, content_type VARCHAR(255) DEFAULT NULL COLLATE BINARY, copyright VARCHAR(255) DEFAULT NULL COLLATE BINARY, author_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, context VARCHAR(64) DEFAULT NULL COLLATE BINARY, cdn_flush_identifier VARCHAR(64) DEFAULT NULL COLLATE BINARY, revtype VARCHAR(4) NOT NULL COLLATE BINARY, provider_metadata CLOB DEFAULT NULL --(DC2Type:json)
        , PRIMARY KEY(id, rev))');
        $this->addSql('INSERT INTO media__media_audit (id, rev, description, enabled, provider_status, width, height, content_size, cdn_is_flushable, cdn_flush_at, cdn_status, updated_at, created_at, name, provider_name, provider_reference, length, content_type, copyright, author_name, context, cdn_flush_identifier, revtype, provider_metadata) SELECT id, rev, description, enabled, provider_status, width, height, content_size, cdn_is_flushable, cdn_flush_at, cdn_status, updated_at, created_at, name, provider_name, provider_reference, length, content_type, copyright, author_name, context, cdn_flush_identifier, revtype, provider_metadata FROM __temp__media__media_audit');
