 ...
 */
final class Version20190409075300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL COLLATE BINARY, color VARCHAR(7) NOT NULL COLLATE BINARY, link VARCHAR(255) NOT NULL COLLATE BINARY, logo_url VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(190) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg AS SELECT id, headline, full_name, color, link, logo_url FROM app_sdg');
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL, color VARCHAR(7) NOT NULL, link VARCHAR(255) NOT NULL, logo_url VARCHAR(255) NOT NULL, full_name VARCHAR(200) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO app_sdg (id, headline, full_name, color, link, logo_url) SELECT id, headline, full_name, color, link, logo_url FROM __temp__app_sdg');
        $this->addSql('DROP TABLE __temp__app_sdg');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55C3E684E0E861BD ON app_sdg (headline)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55C3E684DBC463C4 ON app_sdg (full_name)');
