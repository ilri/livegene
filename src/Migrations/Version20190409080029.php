 ...
 */
final class Version20190409080029 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL COLLATE BINARY, color VARCHAR(7) NOT NULL COLLATE BINARY, link VARCHAR(255) NOT NULL COLLATE BINARY, logo_url VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(189) NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL, color VARCHAR(7) NOT NULL, link VARCHAR(255) NOT NULL, logo_url VARCHAR(255) NOT NULL, full_name VARCHAR(190) NOT NULL COLLATE BINARY)');
