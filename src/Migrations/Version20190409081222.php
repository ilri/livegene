 ...
 */
final class Version20190409081222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_55C3E6849520AA7');
        $this->addSql('DROP INDEX UNIQ_55C3E68436AC99F1');
        $this->addSql('DROP INDEX UNIQ_55C3E684665648E9');
        $this->addSql('DROP INDEX UNIQ_55C3E684DBC463C4');
        $this->addSql('DROP INDEX UNIQ_55C3E684E0E861BD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg AS SELECT id, headline, color, link, logo_url, full_name FROM app_sdg');
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL COLLATE BINARY, color VARCHAR(7) NOT NULL COLLATE BINARY, link VARCHAR(255) NOT NULL COLLATE BINARY, logo_url VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL)');
        $this->addSql('INSERT INTO app_sdg (id, headline, color, link, logo_url, full_name) SELECT id, headline, color, link, logo_url, full_name FROM __temp__app_sdg');
        $this->addSql('DROP TABLE __temp__app_sdg');
        ...
        $this->addSql('DROP INDEX rev_8b656439c25af3f1b06524d0287b16fb_idx');
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg_audit AS SELECT id, rev, headline, color, link, logo_url, revtype, full_name FROM app_sdg_audit');
        $this->addSql('DROP TABLE app_sdg_audit');
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL COLLATE BINARY, color VARCHAR(7) DEFAULT NULL COLLATE BINARY, link VARCHAR(255) DEFAULT NULL COLLATE BINARY, logo_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, revtype VARCHAR(4) NOT NULL COLLATE BINARY, full_name VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id, rev))');
        $this->addSql('INSERT INTO app_sdg_audit (id, rev, headline, color, link, logo_url, revtype, full_name) SELECT id, rev, headline, color, link, logo_url, revtype, full_name FROM __temp__app_sdg_audit');
        $this->addSql('DROP TABLE __temp__app_sdg_audit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_55C3E68436AC99F1');
        $this->addSql('DROP INDEX UNIQ_55C3E6849520AA7');
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg AS SELECT id, headline, full_name, color, link, logo_url FROM app_sdg');
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL, color VARCHAR(7) NOT NULL, link VARCHAR(255) NOT NULL, logo_url VARCHAR(255) NOT NULL, full_name VARCHAR(189) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO app_sdg (id, headline, full_name, color, link, logo_url) SELECT id, headline, full_name, color, link, logo_url FROM __temp__app_sdg');
        $this->addSql('DROP TABLE __temp__app_sdg');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55C3E684E0E861BD ON app_sdg (headline)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55C3E684665648E9 ON app_sdg (color)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55C3E68436AC99F1 ON app_sdg (link)');
        ...
        $this->addSql('DROP INDEX rev_8b656439c25af3f1b06524d0287b16fb_idx');
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg_audit AS SELECT id, rev, headline, full_name, color, link, logo_url, revtype FROM app_sdg_audit');
        $this->addSql('DROP TABLE app_sdg_audit');
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL, color VARCHAR(7) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, logo_url VARCHAR(255) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, full_name VARCHAR(189) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id, rev))');
        $this->addSql('INSERT INTO app_sdg_audit (id, rev, headline, full_name, color, link, logo_url, revtype) SELECT id, rev, headline, full_name, color, link, logo_url, revtype FROM __temp__app_sdg_audit');
        $this->addSql('DROP TABLE __temp__app_sdg_audit');
        $this->addSql('CREATE INDEX rev_8b656439c25af3f1b06524d0287b16fb_idx ON app_sdg_audit (rev)');
        $this->addSql('DROP INDEX IDX_E91B73CF166D1F9C');
        $this->addSql('DROP INDEX IDX_E91B73CF6F37DCD9');
