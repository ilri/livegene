 ...
 */
final class Version20190409082006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL COLLATE BINARY, color VARCHAR(7) NOT NULL COLLATE BINARY, full_name VARCHAR(200) NOT NULL COLLATE BINARY, link VARCHAR(50) NOT NULL, logo_url VARCHAR(80) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL COLLATE BINARY, color VARCHAR(7) DEFAULT NULL COLLATE BINARY, revtype VARCHAR(4) NOT NULL COLLATE BINARY, full_name VARCHAR(200) DEFAULT NULL COLLATE BINARY, link VARCHAR(50) DEFAULT NULL, logo_url VARCHAR(80) DEFAULT NULL, PRIMARY KEY(id, rev))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL, full_name VARCHAR(200) NOT NULL, color VARCHAR(7) NOT NULL, link VARCHAR(255) NOT NULL COLLATE BINARY, logo_url VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE app_sdg_audit');
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL, full_name VARCHAR(200) DEFAULT NULL, color VARCHAR(7) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, link VARCHAR(255) DEFAULT NULL COLLATE BINARY, logo_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id, rev))');
