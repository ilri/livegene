 ...
 */
final class Version20190409082508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg AS SELECT id, headline, color, full_name, link, logo_url FROM app_sdg');
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL COLLATE BINARY, color VARCHAR(7) NOT NULL COLLATE BINARY, link VARCHAR(50) NOT NULL COLLATE BINARY, logo_url VARCHAR(80) NOT NULL COLLATE BINARY, full_name VARCHAR(190) NOT NULL)');
        $this->addSql('INSERT INTO app_sdg (id, headline, color, full_name, link, logo_url) SELECT id, headline, color, full_name, link, logo_url FROM __temp__app_sdg');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_sdg_audit AS SELECT id, rev, headline, color, revtype, full_name, link, logo_url FROM app_sdg_audit');
        $this->addSql('DROP TABLE app_sdg_audit');
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL COLLATE BINARY, color VARCHAR(7) DEFAULT NULL COLLATE BINARY, revtype VARCHAR(4) NOT NULL COLLATE BINARY, link VARCHAR(50) DEFAULT NULL COLLATE BINARY, logo_url VARCHAR(80) DEFAULT NULL COLLATE BINARY, full_name VARCHAR(190) DEFAULT NULL, PRIMARY KEY(id, rev))');
        $this->addSql('INSERT INTO app_sdg_audit (id, rev, headline, color, revtype, full_name, link, logo_url) SELECT id, rev, headline, color, revtype, full_name, link, logo_url FROM __temp__app_sdg_audit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE app_sdg');
        $this->addSql('CREATE TABLE app_sdg (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, headline VARCHAR(50) NOT NULL, color VARCHAR(7) NOT NULL, link VARCHAR(50) NOT NULL, logo_url VARCHAR(80) NOT NULL, full_name VARCHAR(200) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE app_sdg_audit');
        $this->addSql('CREATE TABLE app_sdg_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, headline VARCHAR(50) DEFAULT NULL, color VARCHAR(7) DEFAULT NULL, link VARCHAR(50) DEFAULT NULL, logo_url VARCHAR(80) DEFAULT NULL, revtype VARCHAR(4) NOT NULL, full_name VARCHAR(200) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id, rev))');
